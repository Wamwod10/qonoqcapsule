          ...
          <div className="capstype__card">
            ...
            <div className="capstype__div">
              ...
              <p className="capstype__text">
                ...
                simplicity, and privacy, featuring a cozy 1.2m x 2m bed — ideal
                for solo travelers seeking rest just a few minutes from Tashkent
          ...
          <div className="capstype__card">
            ...
            <div className="capstype__div">
              ...
              <p className="capstype__text">
                ...
                relaxation, with a 2.4m x 2m bed — perfect for couples or small
                families just minutes from Tashkent International Airport.
              </p>
              <div className="caps__card-features">
                <h2 className="caps__ft-title">
                  {t("capsules_features_title")}
